...
class AboutViewController : UIViewController {
    ...
    private func setActions() {
        blog.button.tap = { [weak self] in
            self?.presentURL(string: "https://openwallet.com/blog/")
        }
        twitter.button.tap = { [weak self] in
            self?.presentURL(string: "https://twitter.com/openwalletapp")
        }
        reddit.button.tap = { [weak self] in
            self?.presentURL(string: "https://reddit.com/r/openwallet/")
        }
        //TODO - find this link
        terms.tap = { [weak self] in
            self?.presentURL(string: "https://openwallet.com/terms?")
        }
        privacy.tap = { [weak self] in
            self?.presentURL(string: "https://openwallet.com/privacy-policy")
        }
    }
