...
enum S {
    ...
    enum Alerts {
        ...
        static let pinSetSubheader = NSLocalizedString("Alerts.pinSetSubheader", value:"Use your PIN to unlock your Bread and send money.", comment: "Alert Subheader label")
