...
enum S {
    ...
    enum LoginScreen {
        ...
        static let header = NSLocalizedString("open", comment: "Login Screen header")
    ...
    enum TransactionDetails {
        ...
        static let addressFormat = NSLocalizedString("%@ an address", comment: "Will read 'for and address' or 'to and address'")
    }
